...
const ListSection = () => (
  <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 bg-white">
    ...
    <div className="flex flex-wrap -mx-8 items-center">
      ...
      <div className="w-full lg:w-1/2 px-8">
        <div className="lg:mb-0 pb-0 lg:pb-0 mt-16 lg:mt-0 mx-6 lg:mx-0">
          <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 769.411 524.375">
            ...
            <circle cx="278.224" cy="41.735" r="6.813" fill="#6a7aff" />
            ...
            <circle cx="347.202" cy="146.501" r="6.813" fill="#6a7aff" />
            ...
            <circle cx="450.669" cy="181.423" r="6.813" fill="#6a7aff" />
            ...
            <path
              ...
              fill="#e6e6e6"
            />
            <circle cx="387" cy="41.896" r="21" fill="#6a7aff" />
            <path
              d="M435.5 27.896a3.5 3.5 0 100 7h93a3.5 3.5 0 100-7zM435.5 48.896a3.5 3.5 0 100 7h165a3.5 3.5 0 100-7zM275 216.384H5a5.006 5.006 0 01-5-5v-66.976a5.006 5.006 0 015-5h270a5.006 5.006 0 015 5v66.976a5.006 5.006 0 01-5 5zM5 141.408a3.003 3.003 0 00-3 3v66.976a3.003 3.003 0 003 3h270a3.003 3.003 0 003-3v-66.976a3.003 3.003 0 00-3-3z"
              fill="#e6e6e6"
            />
            <circle cx="40" cy="177.896" r="21" fill="#6a7aff" />
            <path
              d="M88.5 163.896a3.5 3.5 0 000 7h97a3.5 3.5 0 000-7zM88.5 184.896a3.5 3.5 0 000 7h165a3.5 3.5 0 000-7z"
              fill="#e6e6e6"
            />
            <path
              ...
              fill="#3f3d56"
            />
            <circle cx="284" cy="324.896" r="21" fill="#6a7aff" />
            <path
              d="M332.5 310.896a3.5 3.5 0 000 7h89a3.5 3.5 0 000-7zM332.5 331.896a3.5 3.5 0 000 7h165a3.5 3.5 0 000-7zM664.25 346.398c-11.726 35.177-59.695-2.132-59.695-2.132l12.791-133.247c19.188-14.924 39.442-2.132 39.442-2.132z"
              fill="#e6e6e6"
            />
            <path
              fill="#ffb8b8"
            ...
            />
            <path
              d="M581.015 523.629v-.5a15.387 15.387 0 0115.387-15.387l24.144.001v15.888zM660.628 503.584L639.215 378.76l-19.84 123.214-20.1 1.117-5.36-165.086.403-.09c3.324-.745 81.537-17.924 94.359 6.652l.065.124-10.701 159.453z"
              fill="#2f2e41"
            />
